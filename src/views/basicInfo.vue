    ...
    <div class="box-1">
      ...
      <div class="box-1-1" v-if="show_saleInfo">
        ...
        <div class="box-1-0-0" v-if="show_saleRealeState">
          ...
          <div>
            {{ data ? (data.saleRealeState == 0 ? "开盘" : "未开盘") : "" }}
          </div>
        </div>
      ...
      <div class="box-1-1" v-if="show_areaInfo">
        ...
        <div class="box-1-0-0" v-if="show_propertiesPowerMode">
          ...
          <div>
            {{
              data ? (data.propertiesPowerMode == "0" ? "民电" : "商电") : ""
            }}
          </div>
        </div>
        <div class="box-1-0-0" v-if="show_propertiesWaterMode">
          ...
          <div>
            {{
              data ? (data.propertiesWaterMode == "0" ? "民水" : "商水") : ""
            }}
          </div>
        </div>
    ...
    this.$api.post(
      ...
      (response) => {
        if (response.status >= 200 && response.status < 300) {
          ...
          this.show_baseBuiltupArea = this.data
            ? this.data.baseBuiltupArea != ""
            : false;
          this.show_baseAreaCovered = this.data
            ? this.data.baseAreaCovered != ""
            : false;
          this.show_baseOpenDate = this.data
            ? this.data.baseOpenDate != ""
            : false;
          this.show_baseHandoverDate = this.data
            ? this.data.baseHandoverDate != "0"
            : false;
          this.show_basePropertyYears = this.data
            ? this.data.basePropertyYears != ""
            : false;
          ...
          this.show_saleRealeState = this.data
            ? this.data.saleRealeState != "-1"
            : false;
          this.show_salePresale = this.data
            ? this.data.salePresale != ""
            : false;

          this.show_propertiesCars = this.data
            ? this.data.propertiesCars != ""
            : false;
          this.show_propertiesParkeRatio = this.data
            ? this.data.propertiesParkeRatio != ""
            : false;
          this.show_propertiesPowerMode = this.data
            ? this.data.propertiesPowerMode != "-1"
            : false;
          this.show_propertiesWaterMode = this.data
            ? this.data.propertiesWaterMode != "-1"
            : false;
          this.show_propertiesCompany = this.data
            ? this.data.propertiesCompany != ""
            : false;
          this.show_propertiesPlotRatio = this.data
            ? this.data.propertiesPlotRatio != ""
            : false;
          this.show_propertiesAffRate = this.data
            ? this.data.propertiesAffRate != ""
            : false;
          this.show_propertiesType = this.data
            ? this.data.propertiesType != "-1"
            : false;
          ...
          this.show_baseInfo =
            this.show_baseBuiltupArea ||
            this.show_baseAreaCovered ||
            this.show_baseOpenDate ||
            this.show_baseHandoverDate ||
            this.show_basePropertyYears ||
            this.show_developers ||
            this.show_basePhone ||
            this.show_address ||
            this.show_name;
          this.show_saleInfo =
            this.show_saleLayout ||
            this.show_saleRealeState ||
            this.show_salePresale;
          this.show_areaInfo =
            this.show_propertiesCars ||
            this.show_propertiesParkeRatio ||
            this.show_propertiesPowerMode ||
            this.show_propertiesWaterMode ||
            this.show_propertiesCompany ||
            this.show_propertiesPlotRatio ||
            this.show_propertiesAffRate ||
            this.show_propertiesType;
        } 
      }
    );
  },
